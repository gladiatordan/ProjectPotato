...
Func Initialize($aGW, $bChangeTitle = True, $aUseStringLog = False, $aUseEventSystem = True)
	...
	$mAgentBase = MemoryRead(GetScannedAddress('ScanAgentBase', 8) + 0xD) - 8
...
Func Scan()
	...
	; AddPattern('2BCE8B1500000000F7D91BC9') ;85C0750F8BCE
	_('ScanAgentBase:')
	; AddPattern('538B5D0C568B750885') ;568BF13BF07204
	AddPattern('FF50104783C6043BFB75E1') ;568BF13BF07204
	_('ScanCurrentTarget:')
	...
	; AddPattern('8B45188B551085') ; OLD
	AddPattern('83FF10761468D2210000') ; NEW
	_('ScanTraderHook:')
	AddPattern('8955FC6A008D55F8B9BB') ;007BA579
	_('ScanSleep:')
	AddPattern('5F5E5B741A6860EA0000')
	_('ScanSalvageFunction:')
	; AddPattern('33C58945FC8B45088945F08B450C8945F48B45108945F88D45EC506A10C745EC70') ; OLD
	AddPattern('33C58945FC8B45088945F08B450C8945F48B45108945F88D45EC506A10C745EC75') ; NEW
	_('ScanSalvageGlobal:')
...
Func GetNumberOfFoesInRangeOfAgent($aAgent = -2, $aRange = 1250)
 ...
 Func ResignAndReturn()
	Resign()
	Local $lTimeout = GetPing() + 3000, $lDeadlock = TimerInit()
	Do
