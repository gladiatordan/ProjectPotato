...
$CBX_Shields  = GUICtrlCreateCheckbox("Shields", 245, 145, 60, 17)
...
GUICtrlSetState($Purge_Hook, $GUI_DISABLE)
...
Global $Kamas = 763
   ...
   If $Rarity = $RARITY_GOLD and GuiCtrlRead($PickupGolds) Then 
   	Return True
	EndIf

	If GuiCtrlRead($CBX_Shields) and $Rarity = $RARITY_GOLD Then
   ; Rare Shields
   ...
   If $Rarity == $RARITY_GREEN	Then Return False
	...
	If GuiCtrlRead($CBX_Kamas) = $GUI_CHECKED And $rarity = $RARITY_GOLD and $ModelID = 762 Then ;762 = Kamas
