...
;~ Give Speedboost and kill Koss
   SendPacket(0x14, 0x1f, GetHeroId(1), $SKILLID_FallBack, 0,$MeID); Use Fall Back
...
;~ Moveto farming spot
   ...
   If IsRecharged(8) Then UseSkillEx2(8, $hostarget)
...
Func Kebobfirstcasting()
   ...
   TargetNearestEnemy()
   If IsRecharged(5) Then UseSkillEx2(5, -2)
   If IsRecharged(7) Then UseSkillEx2(7, -2)
   If IsRecharged(1) Then UseSkillEx2(1, -2)
EndFunc
...
Func Kebobsettling()
   ...
   If KebobGetNumberOfFoesInRangeOfAgent(-2, 900) <= 7 Then
	  If IsRecharged(6) Then UseSkillEx2(6, -2)
	  Out("Waiting for Group 2.")
	  Do
		 $ii += 1
		 If GetIsDead(-2) Then ExitLoop
		 If GetEffectTimeRemaining($SKILLID_Intimidating_Aura) <= 0 Then UseSkillEx2(5, -2)
		 If GetEffectTimeRemaining($SKILLID_Mystic_Regeneration) <= 0 Then UseSkillEx2(7, -2)
		 If GetEffectTimeRemaining($SKILLID_Sand_Shards) <= 0 And IsRecharged(1) Then UseSkillEx2(1, -2)
		 Sleep(100)
	  Until KebobGetNumberOfFoesInRangeOfAgent(-2, 210) > 7 OR $ii > 3000 ;5min
	  Out("Group 2 settled!")
	  If GetEffectTimeRemaining($SKILLID_Armor_of_Sanctity) <= 0 Then UseSkillEx2(6, -2)
   EndIf
   Sleep(500)
EndFunc
...
Func KebobKill()
   ...
   If IsRecharged(6) Then UseSkillEx2(6, -2)
   If IsRecharged(2) Then UseSkillEx2(2, -2)
   If IsRecharged(3) Then UseSkillEx2(3, -2)
   TargetNearestEnemy()
   If IsRecharged(4) Then UseSkillEx2(4, -1)
   If IsRecharged(1) Then UseSkillEx2(1, -2)
   While KebobGetNumberOfFoesInRangeOfAgent() > 0
	  ...
	  If GetEffectTimeRemaining($SKILLID_Armor_of_Sanctity) <= 0 Then UseSkillEx2(6, -2)
	  If GetEffectTimeRemaining($SKILLID_Mystic_Regeneration) <= 0 Then UseSkillEx2(7, -2)
	  If GetEffectTimeRemaining($SKILLID_Sand_Shards) <= 0 And KebobGetNumberOfFoesInRangeOfAgent(-2,300) > 1 Then UseSkillEx2(1, -2)
	  If GetEffectTimeRemaining($SKILLID_VOS) <= 0 Then UseSkillEx2(2, -2)
	  Sleep(100)
	  Attack(-1)
...
Func KebobPickUpLoot()
   ...
   For $i = 1 To GetMaxAgents()
	  ...
	  If CanPickUp($lItem) Then
		 Do
			If GetMapLoading() == 2 Then Disconnected()
			If $lBlockedCount > 2 Then UseSkillEx2(6,-2)
			PickUpItem($lItem)
			Sleep(GetPing())
			Do
			   Sleep(100)
...
Func SoupMoveRun($DestX, $DestY)
   ...
   Local $Me, $Angle
   Local $Blocked = 0
   If GetEffectTimeRemaining(2218) <= 0 Then UseSkillEx2(5, -2)
   Move($DestX, $DestY)
   Do
	  If GetMapLoading() == 2 Then Disconnected()
	  $Me = GetAgentByID(-2)
...
Func SoupMoveKill($DestX, $DestY)
   ...
   Do
	  ...
	  If DllStructGetData($Me, "HP") < 0.8 Then
		 If GetEffectTimeRemaining(1516) <= 0 Then UseSkillEx2(8, -2)
		 If GetEffectTimeRemaining(1531) <= 0 Then UseSkillEx2(7, -2)
		 If GetEffectTimeRemaining(1510) <= 0 AND IsRecharged(1) Then UseSkillEx2(1, -2)
	  EndIf
	  TargetNearestEnemy()
	  $Me = GetAgentByID(-2)
	  If GetIsDead(-2) Then Return
...
Func SoupKill()
   ...
   If NonMeleeInRange(-2, 1500) > 0 Then
	  ...
	  Sleep(500)
	  If IsRecharged(6) Then UseSkillEx2(6, $TargetAgent)
   ...
   While SoupGetNumberOfFoesInRangeOfAgent(-2, 1250) > 0
	  ...
	  If GetEffectTimeRemaining(1516) <= 0 Then UseSkillEx2(8, -2)
	  If GetEffectTimeRemaining(1531) <= 0 Then UseSkillEx2(7, -2)
	  If GetEffectTimeRemaining(1510) <= 0 AND IsRecharged(1) AND SoupGetNumberOfFoesInRangeOfAgent(-2,300) > 1 Then UseSkillEx2(1, -2)
	  If GetEffectTimeRemaining(1759) <= 0 Then UseSkillEx2(2, -2)
	  Sleep(100)
...
Func SoupKill2()
   ...
   TargetNearestEnemy()
   If IsRecharged(2) Then UseSkillEx2(2, -2)
   If IsRecharged(6) Then UseSkillEx2(6, -1)
...
Func FarmSaladLoop()
   ...
   Do
	  ...
	  If GetEffectTimeRemaining(2218) <= 0 Then UseSkillEx2(8, -2)
...
Func KillNextIboga()
	...
	If DllStructGetData(GetAgentByID(-2), "HP") < 0.3 Then UseSkillEx2(8, -2)
   ...
   Do
	  ...
	  If (DllStructGetData($Me, 'MoveX') == 0 Or DllStructGetData($Me, 'MoveY') == 0) Then
		 ...
		 ElseIf $Blocked > 10 AND $Blocked <= 11 Then
			...
			Out("Blocked at Position: " & $X & ":" & $Y & ". Kill me free.")
			TargetNearestEnemy()
			If IsRecharged(1) Then UseSkillEx2(1, -1)
			Sleep(2000)
			Move($DestX, $DestY)
		 Else
			Out("To much stucked, resign.")
