...
;#include "include\GWA2_Headers.au3"
#include "include\GWA2.au3"
#include "include\GWA2_Modstruct_Items.au3"
#include "include\Constants.au3"
#include "include\Looting.au3"
...
; 			Return False
; 	    EndIf
; 	ElseIf ($lModelID == $MODEL_ID_DYE) Then	; if dye
...
; 	ElseIf($lModelID == $MODEL_ID_GLACIAL_STONES)Then
...
Func Inventory()
  ...
  StoreItemsEx()
  Sleep(GetPing()+500)
  If GUICtrlRead($Store)==$GUI_Checked Then StoreGoldsEx()
  Sleep(GetPing()+500)
...
Func CanSell($aItem)
    ...
    If $lModelID == $MODEL_ID_GLACIAL_STONES Then Return False
	...
	If $LMODELID == $MODEL_ID_DYE Then
		Switch DllStructGetData($aItem, "ExtraID")
			Case $EXTRA_ID_BLACK, $EXTRA_ID_WHITE
				Return False
			Case Else
				Return True
		EndSwitch
  ...
  If CheckArrayAllDrops($lModelID) Then Return False ;Bolt on from chest bot
	...
	If $lModelID == $MODEL_ID_GLACIAL_STONES Then Return True
...
Func RndTravel($aMapID)
	...
	Local $Region[11]   = [1, 3, 4]
  ; Local $Region[11]   = [2, 2, 2, 2, 2, 2, 2, -2, 1, 3, 4]
	Local $Language[11] = [0, 0, 0]
