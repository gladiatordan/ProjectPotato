...
#AutoIt3Wrapper_Icon=..\..\..\Polar Bear\Polar.2016\MyPolarBot\icon.ico
...
Global $RunWayPoints = [[-14431, 15110, "WayPoint 1"], _
		...
		[-10850, -18691, "WayPoint 13"], _  ;-10850, -18691 Safe Spot in the corner next to door
		["Chest", "", ""]]
#EndRegion Vaiables
...
Global Const $gui_main = GUICreate("Polar Bear Farmer v9.7", 335, 270)
GUISetIcon("icon.ico")
GUISetOnEvent($GUI_EVENT_CLOSE, "_exit")
Opt("GUIOnEventMode", True)

Global $Input = GUICtrlCreateCombo("", 10, 30, 150, 25)
GUICtrlSetData(-1, GetLoggedCharNames())
;Global $gui_ipt_Char = GUICtrlCreateInput("", 10, 8, 150, 25)
_WinAPI_SetThemeAppProperties($STAP_ALLOW_NONCLIENT)

$GUISTATS = GUICTRLCREATETAB(0, 0, 335, 370)
GUICTRLCREATETABITEM("Stats")

;Run Stats
GUICtrlCreateGroup("Run Data", 8, 53, 150, 125, BITOR($GUI_SS_DEFAULT_GROUP, $BS_CENTER))

GUICtrlCreateLabel("Wins:", 18, 70, 60, 20)
$gui_lbl_Wins = GUICtrlCreateLabel($iTotalRunsSuccess, 100, 70, 25, 17)

GUICtrlCreateLabel("Fails:", 18, 85, 60, 20)
$gui_lbl_Fails = GUICtrlCreateLabel($iTotalRunsFailed, 100, 85, 25, 17)

GUICtrlCreateLabel("Runs/Hour:", 18, 100, 80, 15)
$gui_lbl_RunsHour = GUICtrlCreateLabel("-", 100, 100, 30, 15)
...
GUICtrlCreateLabel("Last Run:", 18, 130, 85, 15)
$gui_lbl_LastRun = GUICtrlCreateLabel("-", 100, 130, 50, 15)

GUICtrlCreateLabel("Average:", 18, 145, 50, 17)
$gui_lbl_AvgTime = GUICtrlCreateLabel("-", 100, 145, 50, 15)
...
;GUIStartgroup()
GUICtrlCreateLabel("Start:", 165, 215, 50, 17)
;GUICTRLSETFONT(-1, 9, 600, 0) ;BOLT FONT
;GUICTRLSETCOLOR(-1, 255) ;BLUE

$LA_Button = GUICtrlCreateRadio("LA", 200, 215, 40, 17)
;GUICTRLSETFONT(-1, 9, 600, 0) ;BOLT FONT
;GUICTRLSETCOLOR(-1, 255) ;BLUE

$KA_Button = GUICtrlCreateRadio("Kamadan", 245, 215, 85, 17)
;GUICTRLSETFONT(-1, 9, 600, 0) ;BOLT FONT
;GUICTRLSETCOLOR(-1, 255) ;BLUE


GUICtrlCreateLabel("Overall Time:", 18, 160, 100, 15)
Global $gui_lbl_Time = 	GUICtrlCreateLabel("00:00:00", 100, 160, 50, 15)

;Loot
GUICtrlCreateGroup("Loot", 8, 182, 150, 75, BITOR($GUI_SS_DEFAULT_GROUP, $BS_CENTER))
GUICtrlCreateLabel("Polar Bears:", 18, 200, 60, 15)
$gui_lbl_PBear = GUICtrlCreateLabel("0", 120, 200, 25, 15)
GUICtrlCreateLabel("Wintersday Gifts:", 18, 217, 100, 20)
$gui_lbl_WGift = GUICtrlCreateLabel("0", 120, 217, 25, 17)
GUICtrlCreateLabel("Candy Cane Shards:", 18, 234, 110, 20)
$gui_lbl_Canes = GUICtrlCreateLabel("0", 120, 234, 25, 17)


Global $gui_btn_Toggle = 	GUICtrlCreateButton("Start", 165, 175, 160, 30)
GUICTRLSETFONT(-1, 9, 700, 0, "Arial")
GUICTRLSETBKCOLOR(-1, 12451801)

GUICtrlSetState($LA_Button, $GUI_CHECKED)

Global $gui_cbx_Rendering = GUICtrlCreateCheckbox("Disable Rendering", 165, 241, 129, 17)
GUICtrlSetOnEvent($gui_btn_Toggle, "GuiButtonHandler")
GUICtrlSetOnEvent($gui_cbx_Rendering, "ToggleRendering")


GUICtrlCreateLabel("v9.7", 300, 235, 28, 0)
Global $GLOGBOX = GUICtrlCreateEdit("Polar Bear Farm v9.7", 165, 28, 160, 145, BitOR($ES_AUTOVSCROLL, $ES_AUTOHSCROLL, $ES_WANTRETURN, $WS_VSCROLL))
...
GUICtrlCreateGroup("Tools", 8, 056, 318, 118)
Global $gui_cbx_Future   = GUICtrlCreateCheckbox("For Future Use", 18, 70, 129, 17)
Global $gui_cbx_Alc	     = GUICtrlCreateCheckbox("Use Alcohol", 170, 110, 80, 17)
Global $gui_cbx_Sweets   = GUICtrlCreateCheckbox("Use Sweets", 170, 90, 80, 17)
Global $gui_cbx_Canes    = GUICtrlCreateCheckbox("Collect Candy Canes", 170, 150, 140, 17)
Global $gui_cbx_Cupcake  = GUICtrlCreateCheckbox("Use Cupcakes", 18, 110, 86, 17)
Global $gui_lbl_Cupcake  = GUICtrlCreateLabel("", 115, 112, 40, 17)
;Global $gui_cbx_Battle  = GUICtrlCreateCheckbox("Fight in Main Battle", 18, 90, 120, 17)
Global $gui_cbx_District = GUICtrlCreateCheckbox("Change Districts", 18, 90, 120, 17)
Global $gui_cbx_Tonic    = GUICtrlCreateCheckbox("Use WD Tonics", 170, 130, 100, 17)
Global $gui_cbx_Purge    = GUICtrlCreateCheckbox("Purge Engine Hook", 18, 150, 140, 17)
Global $gui_cbx_Party    = GUICtrlCreateCheckbox("Use Party", 170, 70, 80, 17)
Global $gui_cbx_Fight    = GUICtrlCreateCheckbox("Fight in Last Battle", 18, 130, 110, 17)

GUICtrlSetState($gui_cbx_Future,	$GUI_DISABLE)
...
GUICtrlCreateLabel("v9.7", 284, 35, 28, 0)

GUICTRLCREATETABITEM("Notes")
GUICtrlCreateLabel("v9.7", 290, 35, 28, 0)

GUICtrlCreateGroup("NOTES", 8, 55, 315, 210, BITOR($GUI_SS_DEFAULT_GROUP, $BS_CENTER))
GUICTRLSETFONT(-1, 11, 700, 0)

GUICtrlCreateLabel("~  Any proffession, + EOTN expansion", 20, 80, 300, 30)
GUICTRLSETFONT(-1, 9, 500, 0, "Arial")

GUICtrlCreateLabel("~  Best classes: Monk, Assassin, Ranger, Warrior", 20, 100, 300, 30)
GUICTRLSETFONT(-1, 9, 500, 0, "Arial")

GUICtrlCreateLabel("~  If using Monk then equip 20% enchant weapon", 20, 120, 300, 30)
GUICTRLSETFONT(-1, 9, 500, 0, "Arial")

GUICtrlCreateLabel("~  Warrior may be fastest because of dash skill", 20, 140, 300, 30)
GUICTRLSETFONT(-1, 9, 500, 0, "Arial")

GUICtrlCreateLabel("~  Use sweets for in town Speed Boost!", 20, 160, 300, 30)
GUICTRLSETFONT(-1, 9, 500, 0, "Arial")

GUICtrlCreateLabel("~  Use cupcakes for mission Speed Boost!", 20, 180, 300, 30)
GUICTRLSETFONT(-1, 9, 500, 0, "Arial")

GUICtrlCreateLabel("~  Use party and alcohol for titles if needed", 20, 200, 300, 30)
GUICTRLSETFONT(-1, 9, 500, 0, "Arial")

GUICtrlCreateLabel("~  Use WD Tonics for tiles", 20, 220, 300, 30)
GUICTRLSETFONT(-1, 9, 500, 0, "Arial")

GUICtrlCreateLabel("~  Good Luck!!!", 20, 240, 300, 30)
GUICTRLSETFONT(-1, 9, 500, 0, "Arial")
...
Func GuiButtonHandler()
	...
	If $BotRunning Then
	  ...
	  GUICtrlSetData($gui_btn_Toggle, "Force Pause NOW")
	...
	Else
		...
		GUICtrlSetData($gui_btn_Toggle, "Pause")
		WinSetTitle($gui_main, "", "PolarBot v9.7-" & GetCharname())
		$BotRunning = True
		$BotInitialized = True
		$tTotal = TimerInit()
...
Func Main()
	...
	;Selecting Starting Tow & Change District
	...
	If GUICtrlRead($gui_cbx_Alc) = $GUI_CHECKED Then
		...
		If UseItemByModelId($Alcohol_Array) Then
			Out("Lets Get Tipsy!!!")
		Else
			Out("No more Alcohol :(")
		EndIf
	...
	If GUICtrlRead($gui_cbx_Tonic) = $GUI_CHECKED Then
		Out("Drinking Alcohol")
		If UseItemByModelId($Winters_Day_Tonics) Then
			Out("Using Tonic!!!")
		Else
			Out("No more Tonics :(")
		EndIf
...
Func Enter_Kamadan_Quest()
	...
	MoveTo(-8993, 14163)
	MoveTo(-9957, 14315)
	GoNearestNPCToCoords(-10868, 14487)
	;GoToNPC($lGrenth)  ;(-10862, 14472)
...
Func MoveRunning($lDestX, $lDestY, $lRandom = 250)
	...
	If IsRecharged(6) Then 
		Out("Using skill 6 on self")
		UseSkill(6, -2)   				 ;New Line
	EndIf
	;If IsRecharged(6) And $prof = 'W' Then UseSkill(6, -2)  ;Old Line
	Out("Moving to " + $lDestX + "" + $lDestY)
...
Func CanPickUp2($aItem)
	...
	Switch $m
		...
		Case 556 ; Candy Cane Shard
			Return True
		Case 21489 ; Rainbow CCs
			Return True
		Case 6370 ; Peppermint CCs
			Return True
		Case 21488 ; Wintergreen CCs
			Return True
	EndSwitch
	Return False
EndFunc   ;==>CanPickUp2
...
Func Fight()
	...
	Do
		...
		While $enemyID <> 0 And Not $giveup
			...
			$enemyID = SelectTarget()
		WEnd
		Out("Following Freezie " & $MID_Freezie)
		RndSleep(GetPing())
		$Freezie = GetAgentById($MID_Freezie)
