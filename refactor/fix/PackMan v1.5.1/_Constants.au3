...
Global Enum $RANGE_ADJACENT=156, $RANGE_NEARBY=240, $RANGE_AREA=312, $RANGE_EARSHOT=1000, _
			$RANGE_SPELLCAST = 1085, $RANGE_SPIRIT = 2500, $RANGE_COMPASS = 5000

Global Enum $RANGE_ADJACENT_2=156^2, $RANGE_NEARBY_2=240^2, $RANGE_AREA_2=312^2, $RANGE_EARSHOT_2=1000^2, _
			$RANGE_SPELLCAST_2=1085^2, $RANGE_SPIRIT_2=2500^2, $RANGE_COMPASS_2=5000^2

Global Enum $PROF_NONE, $PROF_WARRIOR, $PROF_RANGER, $PROF_MONK, $PROF_NECROMANCER, $PROF_MESMER, _
...
Global Const $TYPE_KIT					= 29	; ID / Salvage + Keg Ale
...
Global Const $MODEL_ID_LUMP_CHARCOAL	= 922
Global Const $MODEL_ID_MONSTROUS_CLAW	= 923
Global Const $MODEL_ID_CLOTH			= 925
Global Const $MODEL_ID_BOLT_LINEN		= 926
Global Const $MODEL_ID_BOLT_DAMASK		= 927
Global Const $MODEL_ID_SILK				= 928
Global Const $MODEL_ID_DUST				= 929
Global Const $MODEL_ID_GLOB_ECTO		= 930
...
Global Const $MODEL_ID_DELDRIMOR_STEEL	= 950
Global Const $MODEL_ID_ROLL_PARCHMENT	= 951
Global Const $MODEL_ID_ROLL_VELLUM		= 952
Global Const $MODEL_ID_SCALES			= 953
Global Const $MODEL_ID_CHITIN			= 954
Global Const $MODEL_ID_GRANITE			= 955
Global Const $MODEL_ID_SPIRITWOOD		= 956
Global Const $MODEL_ID_AMBER			= 6532
Global Const $MODEL_ID_JADEITE			= 6533

Global Const $COMMON_MATS_ARR[11] = [ _
	$MODEL_ID_BONES, $MODEL_ID_IRON, $MODEL_ID_TANNED_HIDES, $MODEL_ID_SCALES, _
	$MODEL_ID_CHITIN, $MODEL_ID_CLOTH, $MODEL_ID_WOOD, $MODEL_ID_GRANITE, _
	$MODEL_ID_DUST, $MODEL_ID_PLANT_FIBRES, $MODEL_ID_FEATHERS _
]
Global Const $RARE_MATS_ARR[25] = [ _
	$MODEL_ID_FUR_SQUARE, $MODEL_ID_BOLT_LINEN, $MODEL_ID_BOLT_DAMASK, $MODEL_ID_SILK, _
	$MODEL_ID_GLOB_ECTO, $MODEL_ID_STEEL_INGOT, $MODEL_ID_DELDRIMOR_STEEL, _
	$MODEL_ID_MONSTROUS_CLAW, $MODEL_ID_MONSTROUS_EYE, $MODEL_ID_MONSTROUS_FANG, _
	$MODEL_ID_RUBY, $MODEL_ID_SAPPHIRE, $MODEL_ID_DIAMOND, $MODEL_ID_ONYX_GEMSTONE, _
	$MODEL_ID_LUMP_CHARCOAL, $MODEL_ID_OBSIDIAN_SHARD, $MODEL_ID_GLASS_VIAL, _
	$MODEL_ID_LEATHER_SQUARE, $MODEL_ID_ELONIAN_LEATHER, $MODEL_ID_VIAL_INK, _
	$MODEL_ID_ROLL_PARCHMENT, $MODEL_ID_ROLL_VELLUM, $MODEL_ID_SPIRITWOOD, _
	$MODEL_ID_AMBER, $MODEL_ID_JADEITE _
]
Global $MATERIAL_STORAGE[6534]
$MATERIAL_STORAGE[$MODEL_ID_BONES]			= 1
$MATERIAL_STORAGE[$MODEL_ID_IRON]			= 2
$MATERIAL_STORAGE[$MODEL_ID_TANNED_HIDES]	= 3
$MATERIAL_STORAGE[$MODEL_ID_SCALES]			= 4
$MATERIAL_STORAGE[$MODEL_ID_CHITIN]			= 5
$MATERIAL_STORAGE[$MODEL_ID_CLOTH]			= 6
$MATERIAL_STORAGE[$MODEL_ID_WOOD]			= 7
$MATERIAL_STORAGE[$MODEL_ID_GRANITE]		= 9
$MATERIAL_STORAGE[$MODEL_ID_DUST]			= 10
$MATERIAL_STORAGE[$MODEL_ID_PLANT_FIBRES]	= 11
$MATERIAL_STORAGE[$MODEL_ID_FEATHERS]		= 12
$MATERIAL_STORAGE[$MODEL_ID_FUR_SQUARE]		= 13
$MATERIAL_STORAGE[$MODEL_ID_BOLT_LINEN]		= 14
$MATERIAL_STORAGE[$MODEL_ID_BOLT_DAMASK]	= 15
$MATERIAL_STORAGE[$MODEL_ID_SILK]			= 16
$MATERIAL_STORAGE[$MODEL_ID_GLOB_ECTO]		= 17
$MATERIAL_STORAGE[$MODEL_ID_STEEL_INGOT]	= 18
$MATERIAL_STORAGE[$MODEL_ID_DELDRIMOR_STEEL] = 19
$MATERIAL_STORAGE[$MODEL_ID_MONSTROUS_CLAW]	= 20
$MATERIAL_STORAGE[$MODEL_ID_MONSTROUS_EYE]	= 21
$MATERIAL_STORAGE[$MODEL_ID_MONSTROUS_FANG]	= 22
$MATERIAL_STORAGE[$MODEL_ID_RUBY]			= 23
$MATERIAL_STORAGE[$MODEL_ID_SAPPHIRE]		= 24
$MATERIAL_STORAGE[$MODEL_ID_DIAMOND]		= 25
$MATERIAL_STORAGE[$MODEL_ID_ONYX_GEMSTONE]	= 26
$MATERIAL_STORAGE[$MODEL_ID_LUMP_CHARCOAL]	= 27
$MATERIAL_STORAGE[$MODEL_ID_OBSIDIAN_SHARD]	= 28
$MATERIAL_STORAGE[$MODEL_ID_GLASS_VIAL]		= 30
$MATERIAL_STORAGE[$MODEL_ID_LEATHER_SQUARE]	= 31
$MATERIAL_STORAGE[$MODEL_ID_ELONIAN_LEATHER] = 32
$MATERIAL_STORAGE[$MODEL_ID_VIAL_INK]		= 33
$MATERIAL_STORAGE[$MODEL_ID_ROLL_PARCHMENT]	= 34
$MATERIAL_STORAGE[$MODEL_ID_ROLL_VELLUM]	= 35
$MATERIAL_STORAGE[$MODEL_ID_SPIRITWOOD]		= 36
$MATERIAL_STORAGE[$MODEL_ID_AMBER]			= 37
$MATERIAL_STORAGE[$MODEL_ID_JADEITE]		= 38
...
Global Const $EVENT_ID_ARRAY[29] =	[28, $MODEL_ID_TOTS, $MODEL_ID_GOLDEN_EGGS, $MODEL_ID_BUNNIES, _
				$MODEL_ID_GROG, $MODEL_ID_SHAMROCK_ALE, $MODEL_ID_CLOVER, $MODEL_ID_PIE, $MODEL_ID_CIDER, _
				$MODEL_ID_POPPERS, $MODEL_ID_ROCKETS, $MODEL_ID_CUPCAKES, $MODEL_ID_SPARKLER, _
				$MODEL_ID_HONEYCOMB, $MODEL_ID_VICTORY_TOKEN, $MODEL_ID_LUNAR_TOKEN, $MODEL_ID_HUNTERS_ALE, _
				$MODEL_ID_PUMPKIN_COOKIE, $MODEL_ID_KRYTAN_BRANDY, $MODEL_ID_BLUE_DRINK, $MODEL_ID_FRUITCAKE, _
				$MODEL_ID_SPIKED_EGGNOGG, $MODEL_ID_EGGNOGG, $MODEL_ID_SNOWMAN_SUMMONER, $MODEL_ID_FROSTY_TONIC, _
				$MODEL_ID_MISCHIEVOUS_TONIC, $MODEL_ID_DELICIOUS_CAKE, $MODEL_ID_ICED_TEA, $MODEL_ID_PARTY_BEACON]

Global Const $ALCOHOL_ID_ARRAY[9] = [8, $MODEL_ID_GROG, $MODEL_ID_SHAMROCK_ALE, $MODEL_ID_CIDER, $MODEL_ID_HUNTERS_ALE, _
				$MODEL_ID_KRYTAN_BRANDY, $MODEL_ID_SPIKED_EGGNOGG, $MODEL_ID_EGGNOGG, $MODEL_ID_ICED_TEA]

Global Const $SWEETS_ID_ARAY[9] = [8, $MODEL_ID_GOLDEN_EGGS, $MODEL_ID_BUNNIES, $MODEL_ID_PIE, $MODEL_ID_HONEYCOMB, _
				$MODEL_ID_PUMPKIN_COOKIE, $MODEL_ID_BLUE_DRINK, $MODEL_ID_FRUITCAKE, $MODEL_ID_DELICIOUS_CAKE]

Global Const $PARTY_ID_ARAY[8] = [7, $MODEL_ID_POPPERS, $MODEL_ID_ROCKETS, $MODEL_ID_SPARKLER, $MODEL_ID_SNOWMAN_SUMMONER, _
				$MODEL_ID_FROSTY_TONIC, $MODEL_ID_MISCHIEVOUS_TONIC, $MODEL_ID_PARTY_BEACON]

Global Const $MATERIAL_ID_ARRAY[14] = [13, $MODEL_ID_BONES, $MODEL_ID_DUST, $MODEL_ID_IRON, $MODEL_ID_FEATHERS, _
				$MODEL_ID_PLANT_FIBRES, $MODEL_ID_SCALES, $MODEL_ID_CHITIN, $MODEL_ID_GRANITE, $MODEL_ID_MONSTROUS_EYE, _
				$MODEL_ID_MONSTROUS_FANG, $MODEL_ID_MONSTROUS_CLAW, $MODEL_ID_RUBY, $MODEL_ID_SAPPHIRE]

Global Const $TOME_ID_ARRAY[3] = [2, $MODEL_ID_TOME_E_SIN, $MODEL_ID_TOME_R_PARA]	;lowest ID and highest ID

;Hero IDs [ID, "short Name"]
Global Enum $HERO_ID_Norgu = 1, $HERO_ID_Goren, $HERO_ID_Tahlkora, $HERO_ID_Master, $HERO_ID_Jin, $HERO_ID_Koss, _
			$HERO_ID_Dunkoro, $HERO_ID_Sousuke, $HERO_ID_Melonni, $HERO_ID_Zhed, $HERO_ID_Morgahn, $HERO_ID_Margrid, _
			$HERO_ID_Zenmai, $HERO_ID_Olias, $HERO_ID_Razah, $HERO_ID_Mox, $HERO_ID_Keiran, $HERO_ID_Jora, $HERO_ID_Brandor, _
			$HERO_ID_Anton, $HERO_ID_Livia, $HERO_ID_Hayda, $HERO_ID_Kahmu, $HERO_ID_Gwen, $HERO_ID_Xandra, $HERO_ID_Vekk, _
			$HERO_ID_Ogden, $HERO_ID_MERCENARY_1, $HERO_ID_MERCENARY_2, $HERO_ID_MERCENARY_3, $HERO_ID_MERCENARY_4, _
			$HERO_ID_MERCENARY_5, $HERO_ID_MERCENARY_6, $HERO_ID_MERCENARY_7, $HERO_ID_MERCENARY_8, $HERO_ID_Miku , $HERO_ID_Zei_Ri

Global Const $HERO_ID[38][2] = [ [37, 1], [1, "Norgu"], [2, "Goren"], [3, "Tahlkora"], [4, "Master"], [5, "Jin"], [6, "Koss"], _
				[7, "Dunkoro"], [8, "Sousuke"], [9, "Melonni"], [10, "Zhed"], [11, "Morgahn"], [12, "Margrid"], [13, "Zenmai"], _
				[14, "Olias"], [15, "Razah"], [16, "Mox"], [17, "Keiran"], [18, "Jora"], [19, "Brandor"], [20, "Anton"], _
				[21, "Livia"], [22, "Hayda"], [23, "Kahmu"], [24, "Gwen"], [25, "Xandra"], [26, "Vekk"], [27, "Ogden"], _
				[28, "Mercenary Hero 1"], [29, "Mercenary Hero 2"], [30, "Mercenary Hero 3"], [31, "Mercenary Hero 4"], _
				[32, "Mercenary Hero 5"], [33, "Mercenary Hero 6"], [34, "Mercenary Hero 7"], [35, "Mercenary Hero 8"], _
				[36, "Miku"], [37, "Zei Ri"] ]
